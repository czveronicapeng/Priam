...
contract sPriamToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Priam", "sPRM", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPRM supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPRM
