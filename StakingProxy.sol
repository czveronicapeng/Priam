...
contract StakingProxy is Ownable {
    ...
    constructor(
        address _hec, // PRM Token contract address
        address _shec, // sPRM Token contract address
    ...
    function stake(uint _amount, address _recipient) external returns (bool) {
        ...
        require(_amount != 0); // why would anyone need to stake 0 PRM?
        ...
        claims[_recipient] = Claim({
            ...
            gons: claimInfo.gons.add(IsPRM(sPRM).gonsForBalance(_amount)),
    ...
    function claim(address _recipient) public {
        ...
        IERC20(sPRM).transfer(_recipient, IsPRM(sPRM).balanceForGons(claimInfo.gons));
    }
